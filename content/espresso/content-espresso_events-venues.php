...
<h3 class="event-venues-h3 ee-event-h3">
	<span class=""></span><?php _e( 'Location', 'event_espresso' ); ?>
</h3>
<div class="espresso-venue-dv">
	<h4><strong> <?php espresso_venue_name(); ?></strong></h4>
<?php  if ( $venue_phone = espresso_venue_phone( $post->ID, FALSE )) : ?>
	<p>
		<span class=""><strong><?php _e( 'Phone:', 'event_espresso' ); ?></strong></span> <?php echo $venue_phone; ?>
	</p>
<?php endif;  ?>
<?php  if ( espresso_venue_has_address( $post->ID )) : ?>
	<strong><span class=""></span><?php _e( 'Address:', 'event_espresso' ); ?></strong>

...
<head>
    ...
    <body><?php
        ...
        foreach( $lead_ids as $lead_id ) {
            ...
            } // $data['field'] foreach loop

        } // $lead_ids foreach loop 
        ...
        ?><div class="dmhcard">
            ...
            if ( ! empty( $output['card'] ) ) {
                ...
                ?><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/FORMIDABLE_PDF_TEMPLATES/images/' . $output['card'] . '-upsidedown.jpg' ); ?>"><?php
            ...
            <div class="inside-msg">
                ...
                if ( ! empty( $output['message'] ) ) {
                    ...
                    echo wp_kses( $output['message'], array( 'br' => array() ) );
